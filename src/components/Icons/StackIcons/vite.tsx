...
const Vite = (props: SVGProps<SVGSVGElement>) => {
  const gradAId = `vite-a-${props.id}`
  const gradBId = `vite-b-${props.id}`
  ...
  return (
    <svg viewBox="0 0 128 128" {...props}>
      ...
      <path
        fill={`url(#${gradAId})`}
        d="M124.766 19.52L67.324 122.238c-1.187 2.121-4.234 2.133-5.437.024L3.305 19.532c-1.313-2.302.652-5.087 3.261-4.622L64.07 25.187a3.09 3.09 0 0 0 1.11 0l56.3-10.261c2.598-.473 4.575 2.289 3.286 4.594z"
      />
      <path
        fill={`url(#${gradBId})`}
